...
--
-- Φιλοξενητής: 127.2.156.130:3306
-- Χρόνος δημιουργίας: 31 Αυγ 2014 στις 18:59:30
...
('1_10080', 'διαθέσιμος', 'που είναι στη διάθεσή μας, ώστε να μπορούμε να τον χρησιμοποιήσουμε:'),
('1_101', 'αβόλευτος ', 'που δεν τον έχουν βολέψει (κάπου). ANT βολεμένος'),
('1_10196', 'διαλεκτικός', 'που ακολουθεί τη διαλεκτική στη διερεύνηση της αντικειμενικής πραγματικότητας:'),
('1_10197', 'διαλεκτικός', 'που έχει σχέση με τη διάλεκτο:'),
...
('1_18078', 'γλυκομίλητος', 'που μιλάει με ηπιότητα και ευγένεια.'),
('1_18152', 'γνώριμος', 'που τον έχουμε γνωρίσει στο παρελθόν, που είναι γνωστός ή οικείος ή εύκολα αναγνωρίζεται'),
...
('1_8464', 'βάναυσος', 'που τον χαρακτηρίζει η βιαιότητα και η σκληρότητα, απότομος, σκληρός'),
('1_8508', 'βαρετός', 'που προκαλεί πλήξη, ανία ή και ενόχληση:'),
('1_8519', 'βαριεστημένος', 'που αισθάνεται ανία, πλήξη'),
...
('1_9649_0', 'δεινός', 'που είναι πολύ ικανός σε κπ. τομέα, που οι ικανότητές του ξεπερνούν κατά πολύ το μέσο όρο και αναγνωρίζονται από τους άλλους'),
('1_9649_1', 'δεινός', 'για να υποδηλώσει το μέγεθος μιας εξαιρετικά δυσάρεστης ή ενοχλητικής κατάστασης· φοβερός, τρομερός'),
('1_9872', 'δηκτικός', '(λόγ.) που είναι οξύς, προσβλητικός στα λόγια, στο ύφος του'),
...
('1_18078', 'Δεν θα ακούσεις κακή κουβέντα από το στόμα του. Είναι πολύ γλυκομίλητος'),
('1_18152', 'Είμαστε παλιοί γνώριμοι.'),
('1_18152', ' Γνώριμη φυσιογνωμία.'),
('1_18152', ' Ο γνώριμος ήχος της καμπάνας.'),
('1_8464', 'Βάναυσος άνθρωπος. '),
('1_8464', ' Bάναυσοι τρόποι. '),
('1_8464', '  Bάναυση συμπεριφορά.'),
('1_8508', 'Mη γίνεσαι βαρετός.'),
('1_8508', ' Το φίλμ μου φάνηκε βαρετό.'),
('1_8519', 'Tον είδα βαριεστημένο και δεν του μίλησα.'),
('1_9649_0', 'Είναι δεινός ρήτορας / συζητητής /  χορευτής / κολυμβητής / σκοπευτής.'),
('1_9649_1', 'Yπέστησαν δεινή ήττα / δεινό πλήγμα. Bρίσκονται σε δεινή οικονομική κατάσταση. Οι πολιορκητές τούς έφεραν σε δεινή θέση'),
('1_9872', 'Δηκτικά λόγια. Δηκτικό χιούμορ.'),
('1_10080', 'Ο διαθέσιμος χρόνος. Διαθέσιμα χρήματα / εμπορεύματα / εισιτήρια. Aντιμετώπισαν την κατάσταση με όλα τα διαθέσιμα μέσα.'),
('1_10196', 'Διαλεκτική μέθοδος. Διαλεκτικός τρόπος διδασκαλίας'),
('1_10197', 'Ο διαλεκτικός τύπος μιας λέξης');
